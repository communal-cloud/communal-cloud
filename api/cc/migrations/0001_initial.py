# Generated by Django 2.1.7 on 2019-04-14 12:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basemodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='cc.BaseModel')),
                ('Name', models.CharField(max_length=50)),
                ('Type', models.IntegerField(choices=[(0, 'NotSpecified'), (1, 'Integer'), (2, 'String'), (3, 'Boolean'), (4, 'DateTime'), (5, 'GeoLocation'), (6, 'Relation'), (7, 'User')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basemodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='cc.BaseModel')),
                ('Value', jsonfield.fields.JSONField(default='{}')),
                ('DataGroup', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='cc.ExecutionData')),
